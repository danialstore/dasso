...
<html class="loading">
  ...
  <body class="vertical-layout" style="background-color:#031e1d;">
    <style>
		h5,h4{
			color:white;
		}
    ...
    <div class="content-wrapper" style="background-color:#031e1d;">
        ...
        <div class="col-md-4">
            <div class="card mb-2">
                <div class="card-body">
                    ...
                    <h5>Limit<span class="badge badge-secondary float-right">10</span></h5>
...
if(total > 10){
  Swal.fire({title: 'No more than 10 cards!!', icon: 'warning', showConfirmButton: false, toast: true, position: 'top-end', timer: 3000});
  return false;
}
